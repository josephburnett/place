window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=1b6dff&fwbuild=dev"};
...
document.write('<script>goog.require("place.core");</script>');
