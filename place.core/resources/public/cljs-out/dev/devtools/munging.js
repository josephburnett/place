...
var o12472 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12472["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12473 = temp__5718__auto____$1;
return (o12473["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12227__auto__ = f;
return (o__12227__auto__["toString"]).call(o__12227__auto__);
} else {
return "";
}
}catch (e12474){var _ = e12474;
return "";
}});
...
try{var o__12227__auto___12476 = t;
(o__12227__auto___12476["cljs$lang$ctorPrWriter"]).call(o__12227__auto___12476,t,writer);
}catch (e12475){var __12477 = e12475;
}
...
var char_code = (function (){var o__12227__auto__ = (new String(char$));
return (o__12227__auto__["charCodeAt"]).call(o__12227__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12227__auto__ = String;
return (o__12227__auto__["fromCharCode"]).call(o__12227__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12478 = num_code;
switch (G__12478) {
case (1):
return (185);
...
var o__12227__auto__ = String;
return (o__12227__auto__["fromCharCode"]).call(o__12227__auto__,superscript_code);
});
/**
...
}catch (e12480){var _e__12234__auto__ = e12480;
return false;
}})())){
...
var vec__12481 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12481,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o12484 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12484["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12485 = temp__5718__auto____$1;
return (o12485["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___12492 = arguments.length;
var i__4737__auto___12493 = (0);
while(true){
if((i__4737__auto___12493 < len__4736__auto___12492)){
args__4742__auto__.push((arguments[i__4737__auto___12493]));

var G__12494 = (i__4737__auto___12493 + (1));
i__4737__auto___12493 = G__12494;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12488){
var vec__12489 = p__12488;
var ns_detector = cljs.core.nth.call(null,vec__12489,(0),null);
...
var G__12495 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12496 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12495;
remaining_tokens = G__12496;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12486){
var G__12487 = cljs.core.first.call(null,seq12486);
var seq12486__$1 = cljs.core.next.call(null,seq12486);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12487,seq12486__$1);
}));
...
var vec__12500 = cljs.core.split_with.call(null,(function (p1__12499_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12499_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12500,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12500,(1),null);
...
var vec__12506 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12506,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12506,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12509 = cljs.core.rest.call(null,remaining_tokens);
var G__12510 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12509;
name_tokens = G__12510;
continue;
} else {
...
var vec__12513 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12513,(0),null);
var arity = cljs.core.nth.call(null,vec__12513,(1),null);
var vec__12516 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12516,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12516,(1),null);
var vec__12519 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12519,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12519,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12519,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12519,(3),null);
...
var vec__12525 = result;
var munged_ns = cljs.core.nth.call(null,vec__12525,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12525,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12525,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12525,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12525,(4),null);
var arity = cljs.core.nth.call(null,vec__12525,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__12529 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__12529,(0),null);
var args = cljs.core.nth.call(null,vec__12529,(1),null);
var vec__12532 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12532,(0),null);
var name = cljs.core.nth.call(null,vec__12532,(1),null);
...
var G__12535 = (arity + (1));
var G__12536 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12537){
var vec__12538 = p__12537;
var arity = cljs.core.nth.call(null,vec__12538,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12538,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12541_SHARP_){
return cljs.core.get.call(null,arities,p1__12541_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12542_SHARP_){
return cljs.core.drop.call(null,(2),p1__12542_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12545){
var vec__12546 = p__12545;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12546,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12543){
var G__12544 = cljs.core.first.call(null,seq12543);
var seq12543__$1 = cljs.core.next.call(null,seq12543);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12544,seq12543__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12554__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12554__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12554__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12554__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12555 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12555,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12555,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12555,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12555,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12555,(4),null);
var arity = cljs.core.nth.call(null,vec__12555,(5),null);
...
var o__12227__auto__ = f;
return (o__12227__auto__["getBasis"]).call(o__12227__auto__);
});
/**
...
}catch (e12559){var _e__12234__auto__ = e12559;
...
var G__12560 = (obj[cljs.core.first.call(null,path)]);
var G__12561 = cljs.core.rest.call(null,path);
obj = G__12560;
path = G__12561;
continue;
} else {
...
var _STAR_ = (function (accum,p__12562){
var vec__12563 = p__12562;
var bit = cljs.core.nth.call(null,vec__12563,(0),null);
var protocol = cljs.core.nth.call(null,vec__12563,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12566){
var vec__12567 = p__12566;
var ns = cljs.core.nth.call(null,vec__12567,(0),null);
var name = cljs.core.nth.call(null,vec__12567,(1),null);
var selector = cljs.core.nth.call(null,vec__12567,(2),null);
...
var post_process = (function (p__12571){
var vec__12572 = p__12571;
var munged_name = cljs.core.nth.call(null,vec__12572,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12572,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12570_SHARP_){
return (obj[cljs.core.first.call(null,p1__12570_SHARP_)]);
}),sorted_matches);
