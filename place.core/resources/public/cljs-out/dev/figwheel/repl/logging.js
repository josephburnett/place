...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__11214_SHARP_){
return parseInt(p1__11214_SHARP_);
...
var c_11217 = (new goog.debug.Console());
var G__11216_11218 = c_11217.getFormatter();
goog.object.set(G__11216_11218,"showAbsoluteTime",false);

goog.object.set(G__11216_11218,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_11217);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__11219_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__11219_SHARP_);
