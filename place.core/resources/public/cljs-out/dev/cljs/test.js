...
var G__11072 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11072,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11072;
}
}));
...
var len__4736__auto___11077 = arguments.length;
var i__4737__auto___11078 = (0);
while(true){
if((i__4737__auto___11078 < len__4736__auto___11077)){
args__4742__auto__.push((arguments[i__4737__auto___11078]));

var G__11079 = (i__4737__auto___11078 + (1));
i__4737__auto___11078 = G__11079;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11074){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11075,G__11076,seq11074__$2);
}));
...
var map__11081 = m;
var map__11081__$1 = (((((!((map__11081 == null))))?(((((map__11081.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11081.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11081):map__11081);
var file = cljs.core.get.call(null,map__11081__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11081__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11081__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11080_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11080_SHARP_));
...
var temp__5720__auto___11083 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11083)){
var message_11084 = temp__5720__auto___11083;
cljs.core.println.call(null,message_11084);
} else {
}
...
var temp__5720__auto___11085 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11085)){
var message_11086 = temp__5720__auto___11085;
cljs.core.println.call(null,message_11086);
} else {
}
...
var output_dir__$1 = (function (){var G__11087 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11087,"/"].join('');
} else {
return G__11087;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11089 = exception.stack;
var G__11089__$1 = (((G__11089 == null))?null:clojure.string.split_lines.call(null,G__11089));
var G__11089__$2 = (((G__11089__$1 == null))?null:cljs.core.get.call(null,G__11089__$1,depth));
if((G__11089__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11089__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11090 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11090,(0),null);
var column = cljs.core.nth.call(null,vec__11090,(1),null);
var vec__11093 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11093,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11093,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11093,(2),null);
...
var m__$1 = (function (){var G__11096 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11100 = (function (){var G__11099 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11099);
} else {
return G__11099;
}
})();
...
return cljs.core.vary_meta.call(null,G__11101,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e11102){var e = e11102;
var G__11103 = e;
var G__11103__$1 = (((G__11103 instanceof cljs.core.Keyword))?G__11103.fqn:null);
switch (G__11103__$1) {
...
var vec__11105 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11105,(0),null);
var types = vec__11105;
...
return cljs.core.map.call(null,(function (p__11108){
var vec__11109 = p__11108;
var ns = cljs.core.nth.call(null,vec__11109,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11109,(1),null);
return (function (){
...
var G__11112 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11112__$1 = (((G__11112 instanceof cljs.core.Keyword))?G__11112.fqn:null);
switch (G__11112__$1) {
case "async":
...
var seq__11113 = cljs.core.seq.call(null,vars__$1);
var chunk__11114 = null;
var count__11115 = (0);
var i__11116 = (0);
while(true){
if((i__11116 < count__11115)){
var v = cljs.core._nth.call(null,chunk__11114,i__11116);
var temp__5720__auto___11118 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11118)){
var t_11119 = temp__5720__auto___11118;
each_fixture_fn.call(null,((function (seq__11113,chunk__11114,count__11115,i__11116,t_11119,temp__5720__auto___11118,v,each_fixture_fn,G__11112,G__11112__$1,env,once_fixtures,each_fixtures,vec__11109,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11119)));
});})(seq__11113,chunk__11114,count__11115,i__11116,t_11119,temp__5720__auto___11118,v,each_fixture_fn,G__11112,G__11112__$1,env,once_fixtures,each_fixtures,vec__11109,ns,vars__$1))
);
} else {
}


var G__11120 = seq__11113;
var G__11121 = chunk__11114;
var G__11122 = count__11115;
var G__11123 = (i__11116 + (1));
seq__11113 = G__11120;
chunk__11114 = G__11121;
count__11115 = G__11122;
i__11116 = G__11123;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11113);
if(temp__5720__auto__){
var seq__11113__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11113__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11113__$1);
var G__11124 = cljs.core.chunk_rest.call(null,seq__11113__$1);
var G__11125 = c__4556__auto__;
var G__11126 = cljs.core.count.call(null,c__4556__auto__);
var G__11127 = (0);
seq__11113 = G__11124;
chunk__11114 = G__11125;
count__11115 = G__11126;
i__11116 = G__11127;
continue;
} else {
var v = cljs.core.first.call(null,seq__11113__$1);
var temp__5720__auto___11128__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11128__$1)){
var t_11129 = temp__5720__auto___11128__$1;
each_fixture_fn.call(null,((function (seq__11113,chunk__11114,count__11115,i__11116,t_11129,temp__5720__auto___11128__$1,v,seq__11113__$1,temp__5720__auto__,each_fixture_fn,G__11112,G__11112__$1,env,once_fixtures,each_fixtures,vec__11109,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11129)));
});})(seq__11113,chunk__11114,count__11115,i__11116,t_11129,temp__5720__auto___11128__$1,v,seq__11113__$1,temp__5720__auto__,each_fixture_fn,G__11112,G__11112__$1,env,once_fixtures,each_fixtures,vec__11109,ns,vars__$1))
);
} else {
}


var G__11130 = cljs.core.next.call(null,seq__11113__$1);
var G__11131 = null;
var G__11132 = (0);
var G__11133 = (0);
seq__11113 = G__11130;
chunk__11114 = G__11131;
count__11115 = G__11132;
i__11116 = G__11133;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11112__$1)].join('')));
